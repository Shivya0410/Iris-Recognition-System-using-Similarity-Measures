...
def load_images_from_directory(directory):
    ...
    for dir in dir1:
        ...
        for filename in dir2:
            img = cv2.imread("utiris/RGB Images" + "/" + str(dir) + "/" + filename)
            i = i +1
            if img is not None:
                images.append(img)
...
def main():
    images = load_images_from_directory('utiris/RGB Images')
    database = []
    ...
    # query_path = 'utiris/RGB Images/797/S6797S05.jpg'
    result = []
    dir1 = os.listdir('utiris/RGB Images')
    dir1.remove('.DS_Store')
    dir1.sort()
    not_match = 0
    is_match = 0
    ...
    for dir in dir1:
        if(ret):
            break
        dir2 = os.listdir('utiris/RGB Images/' + dir)
        dir2.sort()
        for filename in dir2:
            if(filename=="Thumbs.db"):
                continue
            query_path = 'utiris/RGB Images' + '/' + str(dir) + '/' + filename
    ...
    print("Is not a match for " + str(i - not_match))
